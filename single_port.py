...
def run_frontend():
    ...
    try:
        ...
        process = subprocess.Popen([sys.executable, "-m", "http.server", "10000"])
...
def main():
    ...
    print("Frontend will run on http://localhost:10000")
    ...
    try:
        ...
        if wait_for_backend():
            ...
            frontend_process = subprocess.Popen(
                [sys.executable, "-m", "http.server", "10000"],
                cwd=frontend_dir
            )
            
            print("✓ Frontend started on http://localhost:10000")
